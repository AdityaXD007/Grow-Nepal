...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile overlay — sits below the header, no duplicate logo/close */}
      {isOpen && (
        <div className="fixed inset-x-0 bottom-0 top-[57px] z-40 bg-white flex flex-col md:hidden animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Nav links */}
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`px-4 py-4 rounded-xl text-lg font-medium transition-colors ${isActive
          ...
          {/* Bottom CTA */}
          <div className="px-4 pb-10 pt-4 border-t border-slate-100 flex flex-col gap-3">
            <Button
              href="/contact"
              variant="primary"
              size="md"
